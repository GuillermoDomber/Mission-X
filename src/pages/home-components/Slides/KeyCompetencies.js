  ...
  return (
    <>
      <div className="home-slides">
        ...
        <div className="homeSlidesPoint">PARTICIPATION AND COLLABORATION</div>
        <div className="homeSlidesPoint">
